export default function Footer() {
  return (
    <footer className="bg-[#282828] border-t border-gray-700 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          {/* Brand */}
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold text-[#ffa116] mb-2">HintForge</h3>
            <p className="text-gray-400 text-sm">Master DSA with AI Guidance</p>
          </div>
          ...
          <div className="text-gray-400 text-sm text-center md:text-right">
            <p>&copy; {new Date().getFullYear()} HintForge. All rights reserved.</p>
